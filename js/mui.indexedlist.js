...
(function($, window, document) {
	...
	var IndexedList = $.IndexedList = $.Class.extend({
		...
		findElements: function() {
			...
			self.el.barWrap = self.box.querySelector(classSelector('list-bar-wrap'));
		...
		caleLayout: function() {
			var self = this;
			var withoutSearchHeight = (self.box.offsetHeight - self.el.search.offsetHeight - 20);
			self.el.bar.style.height = withoutSearchHeight + 'px';
			self.el.inner.style.height = withoutSearchHeight + 'px';
			...
			//			});
			var barWrapOffsetHeight = self.el.barWrap.offsetHeight;
			self.el.barWrap.style.top = ((withoutSearchHeight - barWrapOffsetHeight) / 2) + 'px';
		},
